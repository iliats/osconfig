...
func setExpectedCommands(ctx context.Context, mockCommandRunner *utilmocks.MockCommandRunner, expectedCommands []utiltest.ExpectedCommand) {
...
func TestRunGooGetUpdate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			setExpectedCommands(ctx, mockCommandRunner, tt.expectedCommands)
